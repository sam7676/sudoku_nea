    ...
    def f_get_hint(x,hint=True):
        ...
        if complete==True:
            ...
            if hint==True:
                ...
                x.hintLabel['text']=move_dict[hint_type]
                ...
                for ind, z in enumerate(hint_pos):
                    ...
                    if type(x.entries[i*9+j]) == tk.Label:
                        continue

                    x.entries[i*9+j]['fg'] = '#ff00ff'
                    ...
                    x.entries[i*9+j].delete('1.0',tk.END)
                    x.entries[i*9+j].insert('1.0',ystr)
